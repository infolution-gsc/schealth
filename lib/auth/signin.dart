...
class _SignInState extends State<SignIn> {
  ...
  static Future<User?> loginUsingEmail({required String email, required String password, required BuildContext context}) async {
          ...
          child: Column(
            ...
            children: [
              ...
              ElevatedButton(
                ...
                onPressed: () async {
                  User? user = await loginUsingEmail(email: _emailController.text, password: _passwordController.text, context: context);
                  print(user);
